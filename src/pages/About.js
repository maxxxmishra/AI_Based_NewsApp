        ...
        <div className="column">
          <div className="card">
            ...
            <div className="container">
              ...
              <p>
                I have an experience in developing projects using the MERN
                (MongoDB, Express, React, Node.js) stack and React Native, and
                is skilled in creating full-stack web applications and mobile
        ...
        <div className="column">
          <div className="card">
            ...
            <div className="container">
              ...
              <p>
                With a deep understanding of the MERN stack, I bring a creative
                approach to building web applications, crafting intuitive user
                experiences and leveraging cutting-edge technologies to deliver
                dynamic and engaging projects.
              </p>
              <p>sm8815163@gmail.com</p>
              <p>
                <button className="button">Contact</button>
              </p>
            </div>
